...
foreach ($arParams['BUTTONS'] as $item) {
    if (isset($item['TYPE']) && $item['TYPE'] === 'crm-deal-button') {
        $dealButton = $item;
        continue;
    }
...
if ($dealButton) {
    $dealButtonId = $toolbarID . '_deal';
?>
    <button onclick="<?= $dealButton['ONCLICK'] ?>;"
            class="ui-btn ui-btn-md ui-btn-light-border ui-btn-themes"
            id="<?= htmlspecialcharsbx($dealButtonId); ?>"><?= $dealButton['TEXT']; ?></button>
    <?
}
...
foreach ($items as $item) {
    ...
    ?>
        <div class="ui-btn-split ui-btn-primary">
            <button id="<?= htmlspecialcharsbx($labelID); ?>"
                    class="ui-btn-main"><?= htmlspecialcharsbx($schemeDescr) ?></button>
