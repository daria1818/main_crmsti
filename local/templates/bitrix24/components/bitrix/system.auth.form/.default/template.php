...
<div class="user-block" id="user-block">
	<span class="ui-icon ui-icon-common-user user-img" onclick="showUserMenu()">
	...
	<div>
		<span class="user-name" id="user-name" onclick="showUserMenu()"><?=$arResult["USER_NAME"]?></span>
		<?
		$APPLICATION->IncludeComponent("rtop:kpi.widget", "", []);
		?>
	</div>
</div>
