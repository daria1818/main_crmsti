			...
			<div id="<?=$id?>_form_wrap" class="calendar-form">
				<form enctype="multipart/form-data" method="POST" name="calendar_entry_edit" id="<?=$id?>_form">
					...
					<div id="<?=$id?>_main_block_wrap" class="calendar-options pinned">
						<?if(!empty($arResult['CUSTOM_TYPE_EVENT'])){?>
							<div class="calendar-options-item calendar-options-item-border">
								<div class="calendar-options-item-column-left">
									<div class="calendar-options-item-name"><?=Loc::getMessage('CUSTOM_TYPE_EVENT')?></div>
								</div>
								<div class="calendar-options-item-column-right">
									<div class="calendar-options-item-calendar">
										<div class="calendar-field-block">
											<select name="event_type" class="calendar-field calendar-field-select">
												<option value=""><?=Loc::getMessage('CUSTOM_TYPE_EVENT_NO')?></option>
												<?foreach($arResult['CUSTOM_TYPE_EVENT'] as $code => $item){?>
													<option value="<?=$code?>" <?=$item['SELECTED']?>><?=$item['NAME']?></option>
												<?}?>
											</select>
										</div>
									</div>
