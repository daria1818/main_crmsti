	...
	<div class="sidebar-block-inner">
		...
		<div class="filter-block filter-field-date-combobox filter-field-date-combobox-interval">
			...
			<div id="report-filter-chfilter">
                <?php
                if($arResult['BAR']){?>
                <div class="filter-field filter-field-eventType chfilter-field-BAR.ID" callback="RTFilter_chooseBoolean">
                    <label for="BAR" class="filter-field-title">Линейка</label>
                    <select id="BAR" name="BAR" class="filter-dropdown" caller="true">
                        <option value=""><?=GetMessage('CRM_REPORT_INCLUDE_ALL')?></option>
                        <?foreach($arResult['BAR'] as $key => $val){ ?>
                            <option value="<?=$val['id']?>"
