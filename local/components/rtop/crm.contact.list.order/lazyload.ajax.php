...
$ajaxLoaderParams = array(
	'url' => '/local/components/rtop/crm.contact.list.order/lazyload.ajax.php?&site='.SITE_ID.'&'.bitrix_sessid_get(),
	'method' => 'POST',
	'dataType' => 'ajax',
...
$APPLICATION->IncludeComponent('rtop:crm.contact.list.order',
