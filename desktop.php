...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"G_VIDEO_IBLOCK_ID"=>"50",
		"G_VIDEO_PATH_TO_FILE"=>"826",
		"G_VIDEO_DURATION"=>"827",
		"G_VIDEO_SECTION_ID"=>"4871",
		"G_VIDEO_ELEMENT_ID"=>"61444",
		"G_VIDEO_WIDTH"=>"400",
		"G_VIDEO_HEIGHT"=>"300",
